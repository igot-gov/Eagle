...
export const CONSTANTS = {
  ...
  NETWORK_HUB_SERVICE_BACKEND_V2: env.NETWORK_HUB_SERVICE_BACKEND_V2 || 'http://localhost:4013',
  ...
  PROFANITY_SERVICE_API_BASE: env.PROFANITY_SERVICE_API_BASE || 'http://localhost:5000',
