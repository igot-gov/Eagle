...
export const CONSTANTS = {
  ...
  DISCUSSION_HUB_DEFAULT_PASSWORD: env.NODE_BB_DEFAULT_PASSWORD || 'nodebbUser123$',
  DISCUSSION_HUB_WRITE_API_KEY: env.NODE_BB_WRITE_API_KEY || '5aaf0ac3-c7ad-4e06-bc1b-5311d462cef3',
  DISCUSSION_HUB_WRITE_API_UID: env.NODE_BB_WRITE_API_UID || 1,
  ...
  USER_PROFILE_API_BASE: env.USER_PROFILE_API_BASE || 'localhost:3004',
