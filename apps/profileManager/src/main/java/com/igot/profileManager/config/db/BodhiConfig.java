...
package com.igot.profileManager.config.db;
...
@EnableCassandraRepositories(basePackages = "com.igot.profileManager.repository.cassandra.bodhi", cassandraTemplateRef = "bodhiTemplate")
