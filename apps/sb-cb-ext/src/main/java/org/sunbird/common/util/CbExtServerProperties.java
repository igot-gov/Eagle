...
//	}
	...
	@Override
	public String toString() {
		return "LexServerProperties [sbextPort=" + sbextPort +", contentServicePort=" + contentServicePort + ", wfServiceHost=" + wfServiceHost 
				+", wfServicePath="+ wfServicePath + ", isUserMultiMapDeptEnabled=" + isUserMultiMapDeptEnabled + ", learnerUrl="+learnerUrl+"]";
	}
