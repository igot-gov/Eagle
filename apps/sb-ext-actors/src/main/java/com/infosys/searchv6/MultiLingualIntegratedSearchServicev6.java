...
//                        break;
                ...
                case SearchConstantsv6.FILTER_PRICE_RANGE_FIELD_KEY:
                    ...
                    filtersGroupMap.put(SearchConstantsv6.TEMPLATE_FILTER_PREFIX + templateFilterPrefix +  capitalizedName + "Gte", priceRange[0]);
                    filtersGroupMap.put(SearchConstantsv6.TEMPLATE_FILTER_PREFIX + templateFilterPrefix +  capitalizedName + "Lte", priceRange[1]);
                    filtersGroupMap.put(SearchConstantsv6.TEMPLATE_FILTER_PREFIX + templateFilterPrefix +  capitalizedName, true);
                ...
                case SearchConstantsv6.FILTER_DURATION_FIELD_KEY:
                    ...
                    for (int i = 0; i < size; i++) {
                        ...
                        if (range == null) {
                            throw new BadRequestException("DURATION/PRICE RANGE INVALID");
                        }
...
//                        }
    ...
    private SearchResponse fetchFromES(ValidatedSearchData validatedSearchData, Map<String, Object> paramsMap) throws Exception {
        ...
        System.out.println("UUID "+ validatedSearchData.getUuid().toString());
