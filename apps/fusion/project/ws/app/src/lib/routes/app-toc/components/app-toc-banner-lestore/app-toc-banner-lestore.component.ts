...
import { AppTocLestoreService } from '../../services/app-toc-lestore.service'
import { MobileAppsService } from '../../../../../../../../../src/app/services/mobile-apps.service'

@Component({
  selector: 'ws-app-app-toc-banner-lestore',
  templateUrl: './app-toc-banner-lestore.component.html',
  styleUrls: ['./app-toc-banner-lestore.component.scss'],
})
export class AppTocBannerLestoreComponent implements OnInit, OnChanges, OnDestroy {
  ...
  constructor(
    ...
    private tocPathfindersSvc: AppTocLestoreService,
