...
@Component({
  selector: 'ws-app-app-toc-overview-lestore',
  templateUrl: './app-toc-overview-lestore.component.html',
  styleUrls: ['./app-toc-overview-lestore.component.scss'],
})
export class AppTocOverviewLestoreComponent implements OnInit, OnChanges, OnDestroy {
  ...
  constructor(
    ...
    private tocSvc: AppTocLestoreService,
