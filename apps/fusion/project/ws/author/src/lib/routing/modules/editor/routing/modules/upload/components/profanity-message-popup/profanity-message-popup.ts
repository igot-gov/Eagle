...
@Component({
  ...
  templateUrl: './profanity-message-popup.html',
  styleUrls: ['./profanity-message-popup.scss'],
})
export class ProfanityMessagePopUpComponent implements OnInit {
  startForm!: FormGroup
  ...
  constructor(
    public dialogRef: MatDialogRef<ProfanityMessagePopUpComponent>,
