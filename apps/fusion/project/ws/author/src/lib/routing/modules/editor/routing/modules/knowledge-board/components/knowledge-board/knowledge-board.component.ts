...
export class KnowledgeBoardComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.contentService.changeActiveCont.subscribe(data => (this.currentContent = data))
