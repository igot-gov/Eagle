...
import { MaqAppService } from './services/maq-app.service'
...
import {
  ...
  IParticipantObj,
  IObjPair,
} from './models/maq-app.model'
@Component({
  selector: 'ws-analytics-maq-app',
  templateUrl: './maq-app.component.html',
  styleUrls: ['./maq-app.component.scss'],
})
export class MaqAppComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private analyticsSrv: MaqAppService,
