...
export const CONSTANTS = {
  ...
  OPEN_SABER_USER_REGISTRY_BASE: env.OPEN_SABER_USER_REGISTRY_BASE || 'http://localhost:8080',
  ...
  CREATE_USER_SUNBIRD_DETAILS_API_BASE: 'https://igot-sunbird.idc.tarento.com',
